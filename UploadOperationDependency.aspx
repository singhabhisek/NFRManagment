...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: 80px; text-align: left; margin-left: 200px;font-family:inherit;">
        ...
        <table style="margin-left: 20px">
            <tr>
                <td colspan="2">
                    <div>Please upload the NFR updated template to store in the database. You can also download the sample NFR Template from <a href="Resources/sample/SampleUpload.xlsx">here</a>. Post upload, please goto <a href="Dashboard">Dashboard</a> screen to view uploaded data</div>
                    <br />
                </td>
            </tr>
            <tr>
